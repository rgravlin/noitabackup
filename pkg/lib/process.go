...
// processID takes a name parameter and returns the process ID of the process with that name.
//
// It uses the Windows API function CreateToolhelp32Snapshot to take a snapshot of the current system information,
...
// If the process is found, it tries to send a Signal(0) to the process, which is a safe way to check
